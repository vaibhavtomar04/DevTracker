...
ALTER TABLE users ADD COLUMN IF NOT EXISTS lock_time DATETIME DEFAULT NULL;
ALTER TABLE users ADD COLUMN IF NOT EXISTS password_reset_required TINYINT(1) NOT NULL DEFAULT 0;
ALTER TABLE users ADD COLUMN IF NOT EXISTS temp_password_expires_at DATETIME DEFAULT NULL;
