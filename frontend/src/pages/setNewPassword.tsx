...
function PolicyItem({ ok, text }: { ok: boolean; text: string }) {
  return (
    <div className={`flex items-center gap-1.5 text-[10px] transition-colors ${ok ? "text-emerald-400" : "text-slate-500"}`}>
      <CheckCircle2 className={`h-3 w-3 flex-shrink-0 transition-colors ${ok ? "text-emerald-400" : "text-slate-600"}`} />
      {text}
    </div>
  )
}
...
export default function SetNewPasswordPage() {
  ...
  }, [mustChangePassword, token, loading, navigate])
  ...
  return (
    <div
      className="relative min-h-screen w-screen flex items-center justify-center overflow-hidden text-foreground"
      style={{ background: "#070a14" }}
    >
      <DotGrid />

      {/* Ambient orbs */}
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] bg-violet-600/8 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-indigo-600/8 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2.5 mb-8">
          <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-violet-600 to-indigo-600 flex items-center justify-center shadow-[0_0_20px_rgba(139,92,246,0.4)]">
        ...
        {/* Card */}
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-2xl shadow-[0_0_60px_rgba(139,92,246,0.1),inset_0_0_0_1px_rgba(255,255,255,0.04)] p-8 space-y-6">
            ...
            {success ? (
              ...
              >
                ...
                >
                  ...
                  <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-green-400 flex items-center justify-center shadow-[0_0_30px_rgba(0,255,150,0.4)]">
              ...
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-5">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <div>
                      <h1 className="text-base font-black text-white">Set Your Password</h1>
                      <p className="text-[10px] text-amber-400/80">First-login security requirement</p>
                    </div>
                  </div>
                ...
                <AnimatePresence>
                  {displayError && (
                    <motion.div
                      ...
                      exit={{ opacity: 0 }}
                      className="flex items-center gap-2 p-3 rounded-xl border border-rose-500/20 bg-rose-500/10 text-rose-300 text-xs"
                    >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full h-10 bg-white/[0.04] border border-white/[0.10] rounded-xl pl-9 pr-10 text-sm text-white placeholder:text-slate-500 outline-none focus:border-violet-500/60 focus:ring-2 focus:ring-violet-500/20 transition-all"
                      />
                      <button
                        type="button"
                    ...
                    {newPassword && (
                      <motion.div initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} className="space-y-1.5">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-[9px] font-bold ml-2.5" style={{ color: strength.color }}>
                            {strength.label}
                          </span>
                        </div>
                        {/* Policy checks */}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className={`w-full h-10 bg-white/[0.04] border rounded-xl pl-9 pr-10 text-sm text-white placeholder:text-slate-500 outline-none focus:ring-2 transition-all ${
                          confirmPassword && confirmPassword !== newPassword
                            ...
                            : "border-white/[0.10] focus:border-violet-500/60 focus:ring-violet-500/20"
                        }`}
                      />
                      <button
                        type="button"
                    ...
                    {confirmPassword && confirmPassword === newPassword && (
                      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-[10px] text-emerald-400 flex items-center gap-1">
