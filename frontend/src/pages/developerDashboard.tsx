...
export default function DeveloperDashboard() {
  ...
  useEffect(() => {
    ...
    fetchSummary()
    if (!FEATURES.ENABLE_NEW_BOOTSTRAP) {
      fetchData(true)
      fetchSprints()
    }
    fetchBugReviews()
                            ...
                            myTasks.map(task => {
                              ...
                              return (
                                <div
                                  ...
                                  className={`p-5 rounded-2xl border transition-all cursor-pointer select-none relative overflow-hidden bg-[#161619] hover:bg-[#1e1e21] hover:border-cyan-500/40 text-left ${selectedTask?.id === task.id ? "border-cyan-500 shadow-[0_0_16px_rgba(6,182,212,0.15)]" : "border-white/[0.06]"
                                    }`}
                                >
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            {selectedTask.expectedSitDeploymentDate && (
                              <div className="space-y-1">
                                ...
                                <span className={`font-bold block ${sla.sitStatus === 'Met SLA' || sla.sitStatus === 'On Track' ? 'text-emerald-400' : 'text-rose-400'
                                  }`}>
                                  {sla.sitStatus}
                                </span>
                            ...
                            {selectedTask.expectedUatDeploymentDate && (
                              <div className="space-y-1">
                                ...
                                <span className={`font-bold block ${sla.uatStatus === 'Met SLA' || sla.uatStatus === 'On Track' ? 'text-emerald-400' : 'text-rose-400'
                                  }`}>
                                  {sla.uatStatus}
                                </span>
                                <span className="text-[9.5px] text-zinc-400 block">
